  ...
  return <div className="page-shell market-detail-page">
    ...
    <div className="market-detail-layout">
      <article className="market-detail-main">
        ...
        <section className="chance-panel" aria-labelledby="chance-heading"><div className="section-heading"><div><span className="eyebrow">YES or NO</span><h2 id="chance-heading">Current forecast</h2></div></div><div className="chance-row"><span>YES</span><strong>{(yesBps / 100).toFixed(0)}%</strong>{orderBookMarket ? <a className="yes-pill" href="#order-book">Trade YES</a> : <MarketTradeLink className="yes-pill" outcome="YES" probability={Math.round(yesBps / 100)} />}<span className="muted-copy">Pays 100 🪶</span></div><div className="chance-row"><span>NO</span><strong>{((10_000 - yesBps) / 100).toFixed(0)}%</strong>{orderBookMarket ? <a className="no-pill" href="#order-book">Trade NO</a> : <MarketTradeLink className="no-pill" outcome="NO" probability={Math.round((10_000 - yesBps) / 100)} />}<span className="muted-copy">Pays 100 🪶</span></div></section>
