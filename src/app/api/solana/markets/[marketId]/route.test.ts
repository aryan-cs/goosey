...
const mocks = vi.hoisted(() => ({ read: vi.fn(), resolve: vi.fn(), rate: vi.fn(), genesis: vi.fn() }));
...
beforeEach(() => {
  ...
  mocks.read.mockResolvedValue({ market: program, finalizedSlot: 100n, marketState: { payoutMilli: 1000n },
