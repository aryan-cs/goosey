...
const migrations = ["20260919210000_solana_wallet_links", "20260919220000_solana_event_journal",
  ...
  "20260920001000_registration_devices", "20260920002000_solana_provisioning_checkpoints"] as const;
