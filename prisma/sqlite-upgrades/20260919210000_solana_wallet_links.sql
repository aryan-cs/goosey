CREATE TABLE "SolanaWalletLinkChallenge" (
  ...
  CONSTRAINT "SolanaWalletLinkChallenge_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "SolanaWalletLink" (
  ...
  CONSTRAINT "SolanaWalletLink_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
